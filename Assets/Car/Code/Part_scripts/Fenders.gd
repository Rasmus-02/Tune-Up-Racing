...
func _process(_delta):
	if (current_color == null or color != current_color or durability != current_durability or (car != null and car.is_in_group("Car") and current_durability != car.fenders_durability)):
		if car != null and car.is_in_group("Car"):
			durability = car.fenders_durability
