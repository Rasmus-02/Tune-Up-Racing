...
func _process(_delta):
	if (current_durability == null or durability != current_durability or (car != null and car.is_in_group("Car") and current_durability != car.exhaust_durability)):
		if car != null and car.is_in_group("Car"):
			durability = car.exhaust_durability
